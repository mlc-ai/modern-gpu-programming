...
3. **Ch 6 (GEMM Steps 1–3)** — Start the GEMM optimization journey: 70ms → 0.11ms
...
- **Part III: GEMM Deep Dive** (Ch 6–8) — A single GEMM kernel, optimized step by step from 70ms to 0.11ms in 9 steps across 3 chapters.
